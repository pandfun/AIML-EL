...
for key, value in preloaded_values.items():
    ...
    # Check if this key has specific limits.
    lim = limits.get(key, {})
    
    # For event_id, use integer settings.
    if key == 'event_id':
